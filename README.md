...
* [Documentación sobre las herramientas utilizadas](#documentación-sobre-las-herramientas-utilizadas)
...
```
El cierre de sesión se da con un endpoint que contiene keycloak, el cual luego de ser positivo redirige al usuario al home inicial. Link:
```
{issuer}/protocol/openid-connect/logout?post_logout_redirect_uri={home_url}&id_token_hint={id_token_hint}
```
...
* Endpoint de keycloak - http://localhost:8180/auth/realms/{Realm}/.well-known/openid-configuration 
