...
const Home = ({navigation}) => {
  ...
  async function configAndLogIn() {
    try {
      ...
      const decoded = jwt_decode(keycloakAccessToken); //Decofifico el accessToken
      setJsonDecode(decoded); //Seteo el accessToken decodificado a una variable global para utilizar el json
    } catch (error) {
