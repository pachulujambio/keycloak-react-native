...
const Home = ({navigation}) => {
  ...
  //Promesa para el decodificado
  const waitingDecoded = () => {
    return new Promise ((resolve, reject)) => {
      if (true) {
        resolve
      }else{
        reject(new Error('No recibió el parámetro'));
      }
    }
  }

  //Promesa para pasar el decodificado a json

  //Promesa para actualizar los datos del usuario
