...
const LogIn = ({route, navigation}) => {
  ...
  if (nameUser == 'Desconectado' && jsonDecode != null) {
    ...
    console.log("NOMBRE JSON:             "jsonDecode.name);
    console.log('NOMBRE DEL USUARIO:           ' + nameUser);
    console.log("RESULTADO INCLUDES:           "jsonDecode.realm_access.roles.includes('realm-admin'));
    console.log('IS ADMIN:      ' + isAdmin);
    console.log("JSON COMPLETO:            "+jsonDecode);
  }
