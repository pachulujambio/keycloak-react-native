...
const Home = ({navigation}) => {
  ...
  async function configAndLogIn() {
    try {
      ...
      //Decofifico el accessToken y lo paso a json
      do {
        const decoded = jwt_decode(keycloakAccessToken); //Objeto necesarío para decodificar el token
      ...
      } while (keycloakAccessToken == null);
    } catch (error) {
