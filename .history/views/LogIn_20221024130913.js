...
const LogIn = ({route, navigation}) => {
  ...
  const [isAdmin, setisAdmin] = useState(false); //Constata el roll del usuario conectado
  ...
  if (jsonDecode == null) {
    ...
    setisAdmin(decoded.realm_access.roles.includes('realm-admin')); //Setea si el usuario es o no es admin
  }
