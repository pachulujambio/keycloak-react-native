...
const LogIn = ({route, navigation}) => {
  ...
  if (isAdmin == null && jsonDecode != null) {
    ...
    console.log(jsonDecode.realm_access.roles.includes('realm-admin'));
    setIsAdmin(jsonDecode.realm_access.roles.includes('realm-admin'));
  }

  // if (stateUser == 'Desconectado' && jsonDecode != null) {
  //   const realms = jsonDecode.realm_access.roles; //Ver los roles del realm y del usuario
  //   console.log(realms);
  //   setIsAdmin(realms.includes('realm-admin')); //Verifica si el usuario es admin
  //   console.log(isAdmin);
  // }
