...
const Home = ({navigation}) => {
  ...
  const [jsonDecode, setJsonDecode] = useState(null); //Constate que almacena el json con los datos del usuario
  const [stateUser, setStateUser] = useState('Desconectado'); //Constante para verificar la conexión del usuario
  const [rollUserConnect, setRollUserConnect] = useState('undefined');
