...
Esta biblioteca depende del proyecto nativo [AppAuth-ios](https://github.com/openid/AppAuth-iOS). A
mantenga la biblioteca React Native independiente de su método de gestión de dependencias, las bibliotecas nativas
no se distribuyen como parte del puente.
